...
//
// `⚠ verify` Every literal here was captured on a pre-1.0 build. Valheim 1.0 lands
// 9 September 2026 and 03 §10 expects log strings to move; WP-M1-17 task 3 re-measures
