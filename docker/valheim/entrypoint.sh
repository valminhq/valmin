...
#
# The four names and this order are copied from the framework package's own
# start_server_bepinex.sh (denikson-BepInExPack_Valheim-5.4.2333), not inferred from the
# on-disk layout. That distinction is the whole of 03 §5.2: inferring them produced 4.x
# names on a 3.x layout, and the server booted perfectly, logged no error, and loaded zero
# mods.
#
